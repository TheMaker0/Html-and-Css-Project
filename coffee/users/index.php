...
<html lang="en">
    <head>
        ...
        <title>Intayon KapeManen Coffee Shop</title>
        ...
        <link rel="icon" type="image/x-icon" href="../assets/images/upper-icon.png"><!--Icon -->
    ...
    <body>
        ...
        <header class="header">
            <a href="#" class="logo">
                <img src="../assets/images/logs.png" class="img-logo" alt="KapeManen Logo">
            </a>
        ...
        <section class="home" id="home">
            <div class="content">
                <h3>Welcome to Intayon KapeManen Coffee Shop, <?php echo $_SESSION['username']; ?>!</h3>
                <p>
        ...
        <section class="about" id="about">
            ...
            <div class="row g-0">
                ...
                <div class="content">
                    <h3>Welcome to KapeManen!</h3>
                    <p>
                        At KapeManen Coffee Shop, we are passionate about coffee and believe
                    ...
                    <p>
                        ...
                        inviting atmosphere at KapeManen is designed to be a haven
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <img src="../assets/images/p1.png" alt="" class="user">
                                <h3>loyd Fe</h3>
                                <div class="stars">
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <img src="../assets/images/quote-img.png" alt="" class="quote">
                                <p>
                                    Great Great Taste po siya.
                                </p>
                                <img src="../assets/images/p2.png" alt="" class="user">
                                <h3>James Baranda</h3>
                                <div class="stars">
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <img src="../assets/images/p3.png" alt="" class="user">
                                <h3>Del mar Christoper</h3>
                                <div class="stars">
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
        ...
        <section class="footer">
            <div class="footer-container">
                <div class="logo">
                    <img src="../assets/images/icon-logo.png" class="img"><br />
                    <i class="fas fa-envelope"></i>
                    <p>glenm906@gmail.com</p><br />
                    <i class="fas fa-phone"></i>
                    <p>+639663275965</p><br />
                    <i class="fab fa-facebook-messenger"></i>
                    <p>@KapeManenCoffee</p><br />
                </div>
                <div class="support">
                    <h2>Support</h2>
                    <br /> 
                ...
                <div class="credit">
                    <hr /><br/>
                    <h2>KapeManen Brewed Coffee © 2023 | All Rights Reserved.</h2>
                    <h2>Designed by <span>Computer Science Student</span></h2>
                </div>
            </div>
        </section>
        ...
        <script>
            ...
            function initMap() {
                var map = new google.maps.Map(document.getElementById('map'), {
                    center: {lat: 15.4902778, lng: 120.6138889},
                    zoom: 14
                });

                var marker = new google.maps.Marker({
                    position: {lat: 15.4902778, lng: 120.6138889},
                    map: map,
                    title: 'Your Location'
                });
            }
